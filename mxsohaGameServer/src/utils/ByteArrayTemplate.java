...
public class ByteArrayTemplate {
	...
	@Test
	public void test() {
		byte[] bs = parseByteArray(9877);
		System.out.println(Arrays.toString(bs));
		System.out.println(-107 + 256);
	}
	
	private byte []message = new byte[]{(byte) 0xA3, 0x23, 
			0x01,0x34, 				//设置用户校验id
			0x00,0x00,0x27,0x10, 	//设置用户金币数量
			0x00,0x00,0x33,0x61, 	//设置用户总玩分，消耗的积分
			0x00,0x00,0x26,0x65, 	//设置用户总得分
			0x00,0x58, 				//设置用户本次押分
			0x00,0x00,0x17,0x00, 	//设置座位的总积分
			0x00,0x00,0x02,0x49, 	//设置座位的总得分
			0x62, 					//设置玩家难度
			0x62, 					//设置座位难度
			0x00,0x32, 				//设置玩家游戏局数
			0x65,					//设置玩家次数
